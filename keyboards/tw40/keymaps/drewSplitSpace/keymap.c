...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_LCTRL, KC_LGUI, KC_LALT, MO(_NUM_SYM), KC_SPC, KC_NO, LT(_NAV,KC_SPACE), KC_DEL, KC_DEL, KC_LEFT, KC_DOWN, KC_RGHT
    ...
    [_NAV] = LAYOUT_all(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_UP, KC_END, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS,
