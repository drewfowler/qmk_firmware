...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    LGUI_T(KC_Z),  LALT_T(KC_X),  KC_C,  KC_V,  KC_B,                        KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,
  ...
  [_NAV] = LAYOUT(
    RESET,  KC_TRNS,  AG_NORM,  AG_SWAP,  DEBUG,                            KC_GRV,  KC_PGUP,  KC_UP,  KC_PGDN,  KC_SCLN,
    RGB_TOG,  RGB_HUI,  RGB_SAI,  RGB_VAI,  KC_TRNS,                        KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_END,
    RGB_MOD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  KC_TRNS,                        KC_MINS,  KC_RO,  KC_COMM,  KC_DOT,  KC_BSLS,
                        KC_TRNS,  KC_TRNS,  RGB_HUI,                        RGB_HUD,  KC_TRNS,  KC_NO
  ),
  [_NUM] = LAYOUT(
    KC_TRNS,  KC_F9,  KC_F10,  KC_F11,  KC_F12,                             KC_PPLS,  KC_7,  KC_8,  KC_9,  KC_PSLS,
    KC_TRNS,  KC_F5,  KC_F6,  KC_F7,  KC_F8,                                KC_P0,  KC_4,  KC_5,  KC_6,  KC_PDOT,
    KC_TRNS,  KC_F1,  KC_F2,  KC_F3,  KC_F4,                                KC_PMNS,  KC_1,  KC_2,  KC_3,  KC_PAST,
                KC_TRNS,  KC_TRNS,  RGB_HUI,                                RGB_HUD,  KC_NO,  KC_TRNS
  ),
};
...
const uint16_t PROGMEM combo_ent[] = {KC_J, KC_H, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  [COMBO_BSPC] = COMBO(combo_ent,KC_ENT),
